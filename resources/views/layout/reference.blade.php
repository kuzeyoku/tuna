                    ...
                    <div class="slick_slider"
                            ...
                            <div class="prt-client-logo-tooltip">
                                <div class="prt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="140" height="32" class="img-fluid"
                                            src="{{ asset('assets/images/client/client-01.png') }}"
                                            alt="image">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="prt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="171" height="32" class="img-fluid"
                                            src="{{ asset('assets/images/client/client-02.png') }}"
                                            alt="image">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="client-box">
                            <div class="prt-client-logo-tooltip">
                                <div class="prt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="171" height="40" class="img-fluid"
                                            src="{{ asset('assets/images/client/client-03.png') }}"
                                            alt="image">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="client-box">
                            <div class="prt-client-logo-tooltip">
                                <div class="prt-client-logo-tooltip-inner">
                                    <div class="client-thumbnail">
                                        <img width="187" height="40" class="img-fluid"
                                            src="{{ asset('assets/images/client/client-04.png') }}"
                                            alt="image">
                                    </div>
                                </div>
                            </div>
