                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <video autoplay muted loop>
                            <source src="{{ asset('assets/images/video/production.mp4') }}" type="video/mp4">
                        </video>
                    </div>
                </div>
            </div>
        @elseif(config('setting.general.slider_type', 'image') == 'image')
                ...
                <rs-slides>
                    <rs-slide data-key="rs-1" data-title="Slide" data-thumb="{{ $slider->getImageUrl() }}"
                        ...
                        <rs-layer id="slider-1-slide-4-layer-0" data-type="text" data-rsp_ch="on"
                            ...
                            data-text="w:normal;s:16;l:26,26,26,20;fw:400;" data-vbility="t,t,f,f"
