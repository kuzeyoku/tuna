...
@section('content')
    ...
    {!! Form::open(['url' => route("admin.{$route}.update", $education), 'method' => 'put', 'files' => true]) !!}
    {!! Form::file('image', [
        'class' => 'dropify',
        'data-default-file' => $education->getImageUrl(),
    ]) !!}
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="form-group">
                ...
                {!! Form::number('order', $education->order, ['placeholder' => __('admin/general.order_placeholder')]) !!}
            </div>
        </div>
        <div class="col-lg-6">
            <div class="form-group">
                {!! Form::label('status_', __('admin/general.status')) !!} <span class="manitory">*</span>
                {!! Form::select('status', statusList(), $education->status) !!}
            </div>
        </div>
    </div>
